...
@ComponentScan({ "tokyo.huyhieu.jparelationship" })
@EnableJpaRepositories(basePackages = { "tokyo.huyhieu.jparelationship.repository" })
public class PersistenceJPAConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactoryBean.setPackagesToScan(new String[] { "tokyo.huyhieu.jparelationship.model" });
